...
import { motion } from "framer-motion"; // motion/react ke jagah framer-motion
...
const Hero = () => {
  ...
  return (
    <div style={BgImg} >
      <div className="h-[800px]  flex justify-center items-center py-16">
        {/* Navbar */}
        <motion.div
        ...
        <div className="w-full h-screen grid grid-cols-3 items-center px-10 gap-10">
          ...
          <div className="flex flex-col relative gap-28 px-0 ">
            <motion.h1
              ...
              animate={{
                x: [-200, 0, -8, 8, -5, 5, -2, 2, 0], // slide + shake
                opacity: 1
              }}
              transition={{
                duration: 1.2,
          ...
          <motion.div
            ...
            animate={{
              y: [100, 40, -20, 30, 15, 0], // thoda bounce
              scale: 1,
              opacity: 1,
              zIndex: 10,
            }}
